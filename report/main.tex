...
\begin{figure}[htb]
  ...
  \caption{Independent \texttt{spatstat} confirmation: per-block inhomogeneous $L_{\rm inhom}(r)-r$
           ...
           the seven super-site blocks, extended to $r=3$\,km. Observed lies above the envelope in
           every block, confirming residual aggregation beyond host that persists past 1\,km.}
...
\begin{figure}[htb]
  ...
  \caption{Residual mortality aggregation beyond forest host. Inhomogeneous $L_{\rm inhom}(r)-r$
           ...
           estimator (Figures~\ref{fig:hostcond-ss},~\ref{fig:hostcond-rigor}) extends the range to
           3\,km.}
  \label{fig:hostcond}
\end{figure}
