...
First, with the data in hand: a tree-level (rather than centroid) treatment of the same
inhomogeneous point-process analysis, and a variance-stabilised, large-window estimator to extend
reliably beyond 1\,km---both pure-computation refinements of the analysis presented here. Second,
...
truth---would calibrate, rather than merely bound, the detector confound. Third, and requiring new
