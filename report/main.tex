...
individual-tree mortality segmentation model of \citet{junttila2024significant} to
...
\begin{table}[htb]
  ...
  \begin{tabular}{lccc}
    \toprule
    \textbf{Block (approx.\ location)} & \textbf{$n$ clusters} & \textbf{Type\,0 \%} & \textbf{$r$(AR, comp.)} \\
    \midrule
...
(range 0.973--0.978 across 5 spatial folds; Figure~\ref{fig:shap}); re-running the cross-validation
