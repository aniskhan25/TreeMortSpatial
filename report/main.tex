...
variance-stabilised treatment (future work). Analyses use cluster centroids; the tree-level process
...
to confidence only weakly ($\rho=0.07$). We interpret the residual cautiously: it is established at
the centroid scale on a 7-block sample to $r\lesssim1$\,km; the tree-level process, scales beyond
1\,km, and a formal variance-stabilised test are deferred to a spatstat treatment.
