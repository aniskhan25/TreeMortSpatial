% Compile with pdflatex only (run it twice for internal refs). This document has NO citations,
% so do NOT run bibtex on it -- bibtex would error with "I found no \citation command".
